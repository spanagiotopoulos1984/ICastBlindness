...
const SPELLS = [{
	...
	spell_ingredients = '1 toothpick and 1 bacon',
	...
	spell_ingredients = '1 bacon and 1 blackshroom',
	...
	spell_ingredients = '1 toothpick, 1 bacon, 1 discareded wrappers and 1 blackshroom',
	...
	spell_ingredients = 'NEEDS THEM ALL! Only one times.',
